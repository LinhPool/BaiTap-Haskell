...
test = ("Bordeaux in France","Tuscany in Italy","Rioja in Spain") :: Region
-- Question 3
...
data Kind = Red | White | Rose
kind' :: Kind-> String
kind' a
  |a== Red = "red wine with 14.5% alcohol"
  |a== White = "white wine with 13% alcohol"
  |a== Rose = "Rose wine with 12% alcohol"
  |Otherwite "No"
-- Question 4
...
data Label = Label {name:: Grape, region:: Region, kind:: Kind, alcohhol::String  }
larrosaRose = Label "Larrosa Rose is a rose wine" "from the region Rioja" "It is made from the Garnacha grape" "has a alcohol level of 14%"
castiglioni = Label "Castiglioni is a red wine" "from the region of Tuscany" "It is made from the grape Sangiovese" "has an alcohol level of 12.5%"
lePetitHaitLafitte = Label "Bordeaux is known for its red wine" "Le Petit Haut Lafitte" "these are mainly a blend between Cabernet-sauvignon and Merlot" "has an alcohol percentage 13.5%."
-- Question 5
